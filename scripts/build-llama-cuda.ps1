...
#
# Usage:
#   .\scripts\build-llama-cuda.ps1 [-Version b10069] [-Clean]
#
# Output:
...
param(
    [string]$Version = "b10069",  # Latest stable llama.cpp release tag
    [switch]$Clean
)
...
if (Test-Path $rootCMakePath) {
    ...
    # Comment out add_subdirectory(app) -- new in b10069, depends on llama-server-impl
