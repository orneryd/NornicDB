...
func NornicDBCLIFlagEmbeddingProvider() Message {
	return nornicDBCLIText(MessageNornicDBCLIFlagEmbeddingProvider, "Embedding provider: local, ollama, openai, orca, voyage")
}
func NornicDBCLIFlagEmbeddingURL() Message {
	return nornicDBCLIText(MessageNornicDBCLIFlagEmbeddingURL, "Embedding API URL (ollama/openai/orca/voyage)")
}
