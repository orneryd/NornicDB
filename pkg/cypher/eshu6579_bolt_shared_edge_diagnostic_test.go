...
// around eshu6579BoltCall. Both helpers also recognize typed Outdated errors
// emitted by current upstream localized conflicts. The predicate below mirrors Eshu
