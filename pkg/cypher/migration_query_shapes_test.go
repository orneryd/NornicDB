...
`)
	...
	bindings, relBindings := exec.executeFirstMatch(context.Background(), matchClauses[0])
	require.NotEmpty(t, bindings)
	bindings, _ = exec.executeChainedMatch(context.Background(), matchClauses[1], bindings, relBindings)
	require.NotEmpty(t, bindings)
