...
var settingsRegistry = []SettingDefinition{
	...
	{Name: "db.nornic.embedding.voyage.mode", EnvironmentVariable: "NORNICDB_EMBEDDING_VOYAGE_MODE", Type: "enum", Category: "Embeddings", Scope: ScopeDatabase, Dynamic: true, RestartLevel: RestartNone, HotReload: HotReloadSearchRebuild, ValidValues: []string{"text", "contextualized"}},
