...
var settingsRegistry = []SettingDefinition{
	...
	{Name: "db.nornic.embedding.mode", EnvironmentVariable: "NORNICDB_EMBEDDING_MODE", Type: "string", Category: "Embeddings", Scope: ScopeDatabase, Dynamic: true, RestartLevel: RestartNone, HotReload: HotReloadSearchRebuild},
